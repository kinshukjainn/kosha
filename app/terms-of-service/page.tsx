...
export default function TermsOfService() {
  return (
    <div className="min-h-screen bg-[#050505] text-gray-200  selection:bg-[#0078D4] selection:text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[#0078D4] opacity-[0.03] blur-[120px] pointer-events-none rounded-2xl" />
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 py-16 lg:py-24 relative z-10">
        ...
        <div className="mb-16 pb-10 border-b border-[#222]">
          <div className="flex items-center gap-2 mb-6">
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-2xl bg-[#0078D4]/10 border border-[#0078D4]/20 text-[#0078D4] text-xs font-bold tracking-widest uppercase">
          ...
          <section>
            ...
            <div className="relative mt-6 border border-[#333] bg-[#0a0a0c] rounded-2xl p-6 md:p-8 overflow-hidden group hover:border-[#444] transition-colors">
              ...
              <div className="relative z-10 flex items-start gap-4 mb-5">
                <div className="mt-1 flex-shrink-0 w-10 h-10 rounded-2xl bg-red-500/10 flex items-center justify-center text-red-400 border border-red-500/20">
              ...
              <div className="relative z-10 pl-0 md:pl-14">
                ...
                />
                <div className="mt-6 p-4 bg-[#111] border border-[#222] rounded-2xl text-[14px] text-gray-400 italic">
