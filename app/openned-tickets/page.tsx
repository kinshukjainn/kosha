      ...
      {parts.map((part, i) => {
        if (regex.test(part)) {
          return (
            <mark
              key={i}
              className="bg-[#fff100] text-black px-0.5 rounded-2xl font-semibold"
            >
              {part}
            </mark>
          );
...
export default function FeedbacksList() {
  ...
  const inputClass =
    "w-full px-3 py-2  border-2 border-[#444444] text-[17px] outline-none text-gray-100 placeholder-gray-500  rounded-2xl transition-all";
  ...
  return (
    <div className="w-full min-h-screen bg-[#161923] text-gray-100">
      {/* Page Header */}
      <div className="bg-[#161923] border-b border-[#2d2d2d]">
        <div className="px-6 py-4 max-w-7xl mx-auto w-full">
          <div className="flex items-center gap-4">
            <div
              className="w-12 h-12
             bg-slate-700 rounded-2xl flex items-center justify-center shrink-0"
            >
        ...
        <div className="bg-[#161923] px-6 py-3 ">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8">
        {isLoading ? (
          <div className=" flex flex-col items-center justify-center min-h-[40vh] gap-3 p-8 rounded-2xl">
          ...
          <div className=" flex flex-col items-center justify-center min-h-[40vh] p-8 text-center rounded-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {filteredFeedbacks.map((fb) => {
              ...
              return (
                <article
                  key={fb.id}
                  className="bg-[#18181b] border border-[#2d2d2d] p-5 rounded-2xl shadow-sm hover:border-[#444444] transition-colors flex flex-col"
                >
                  {/* Card Header */}
                  <div className="flex flex-wrap items-center justify-between gap-3 mb-4 pb-3 border-b border-[#2d2d2d]">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="ml-2 flex items-center gap-1 text-[11px] font-semibold text-white bg-green-900 px-1.5 py-1.5 rounded-2xl  uppercase">
                  ...
                  <footer className="pt-3 border-t border-[#2d2d2d] flex flex-wrap items-center justify-between mt-auto gap-4">
                    <div className="flex items-center gap-2.5">
                      <div className="w-6 h-6 rounded-2xl bg-blue-800 flex items-center justify-center text-white shrink-0">
                        <User size={17} />
                      </div>
                    ...
                    <div className="flex items-center gap-1.5">
                      {fb.github_id ? (
                        <a
                          ...
                          className="text-gray-400 hover:text-[#0078D4] hover:bg-[#2a2a2a] p-1.5 rounded-2xl transition-colors"
                        >
                          <LuGithub size={18} />
                        </a>
                      ) : null}
