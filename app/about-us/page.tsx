...
const primaryButtonClass =
  "inline-flex w-fit items-center justify-center gap-2 py-2 px-4 font-semibold text-[14px] bg-black dark:bg-white text-white dark:text-black rounded-full transition-colors dark:hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-black";
...
export default function AboutUs() {
  const links = [
    {
      ...
      icon: (
        <FaGlobe className="w-5 h-5 text-gray-900 dark:text-gray-400  transition-colors" />
      ),
    },
    {
      title: "Read the Blog",
      ...
      icon: (
        <FaPenNib className="w-5 h-5 text-gray-900 dark:text-gray-400  transition-colors" />
      ),
    },
    {
      ...
      icon: (
        <FaCommentDots className="w-5 h-5 text-gray-900 dark:text-gray-400  transition-colors" />
      ),
    },
    {
      ...
      icon: (
        <FaMugHot className="w-5 h-5 text-gray-900 dark:text-gray-400  transition-colors" />
      ),
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-gray-300 py-16 px-4 sm:px-6 md:px-8 selection:bg-gray-800 selection:text-white ">
      <div className="max-w-3xl mx-auto space-y-16">
        ...
        <section className="flex flex-col gap-6">
          ...
          <p className="text-base text-gray-900 dark:text-gray-200 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-3xl bg-gray-200 dark:bg-[#141414]">
            <div>
              ...
              <p className="text-sm text-gray-900 dark:text-gray-300 max-w-md">
        ...
        <section className="flex flex-col sm:flex-row gap-6 sm:gap-8 pt-8">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-base text-gray-900 dark:text-gray-400 leading-relaxed">
            ...
            <div className="flex items-center gap-4 pt-2">
              {socialLinks.map((social, idx) => (
                <a
                  ...
                  className="text-black dark:text-blue-400  transition-colors"
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {links.map((link, index) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex flex-col p-5 bg-gray-200 dark:bg-[#141414]  transition-colors rounded-3xl h-full"
              >
                <div className="flex items-center gap-3 mb-3">
                  {link.icon}
                  <h4 className="text-sm font-semibold text-black dark:text-white  transition-colors">
                    {link.title}
                  </h4>
                </div>
                <p className="text-sm text-black dark:text-gray-200 leading-relaxed mb-4 flex-1">
                  {link.description}
                </p>
                <div className="text-xs  font-medium text-blue-800 dark:text-blue-400 transition-colors mt-auto">
                  Visit Link &rarr;
                </div>
              </a>
            ))}
