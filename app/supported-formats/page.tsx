    ...
    <div className="min-h-screen text-gray-900 pb-24 bg-black  selection:bg-[#cce3f5]">
      ...
      <main className="max-w-[1000px] mx-auto px-6 pt-12">
        ...
        <nav
          ...
          className="mb-14 p-5 bg-[#141414] rounded-2xl shadow-sm"
        >
        ...
        <section id="images" className="mb-16 scroll-mt-20">
          ...
          <div className="flex flex-wrap bg-[#141414] p-5  rounded-2xl rounded-2xl shadow-sm">
        ...
        <section id="videos" className="mb-16 scroll-mt-20">
          ...
          <div className="flex flex-wrap bg-[#141414] p-5  rounded-2xl shadow-sm">
        ...
        <section id="documents" className="mb-16 scroll-mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {DOC_CATEGORIES.map((cat) => (
              <div
                key={cat.label}
                className="p-5 bg-[#141414]  rounded-3xl shadow-sm hover:shadow-md transition-shadow"
              >
        ...
        <section id="archives" className="mb-16 scroll-mt-20">
          ...
          <div className="flex flex-wrap bg-[#141414] p-5  rounded-2xl rounded-2xl shadow-sm mb-6">
